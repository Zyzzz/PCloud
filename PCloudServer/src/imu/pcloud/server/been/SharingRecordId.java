...
public class SharingRecordId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SharingRecordId) ) return false;
		 SharingRecordId castOther = ( SharingRecordId ) other; 
         
		 return ( (this.getPersonalPlanId()==castOther.getPersonalPlanId()) || ( this.getPersonalPlanId()!=null && castOther.getPersonalPlanId()!=null && this.getPersonalPlanId().equals(castOther.getPersonalPlanId()) ) )
 && ( (this.getPlanCircleId()==castOther.getPlanCircleId()) || ( this.getPlanCircleId()!=null && castOther.getPlanCircleId()!=null && this.getPlanCircleId().equals(castOther.getPlanCircleId()) ) );
   }
   
   public int hashCode() {
         int result = 17;
         
         result = 37 * result + ( getPersonalPlanId() == null ? 0 : this.getPersonalPlanId().hashCode() );
         result = 37 * result + ( getPlanCircleId() == null ? 0 : this.getPlanCircleId().hashCode() );
         return result;
   }   
